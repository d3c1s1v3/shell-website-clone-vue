...
import type { IconItemI, MenuItemI } from '@/models/models'
...
const menuItems: MenuItemI[] = [
  ...
  {
    id: 'paliwa-oleje-i-plyny-do-chlodnic',
    ...
    children: [
      {
        ...
        type: 'link',
        to: '/paliwa-oleje-i-plyny-do-chlodnic',
      },
      {
        id: 'fuels',
        ...
        children: [
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa',
          },
          {
            id: 'shell-vpower',
            label: 'Shell V-Power',
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-vpower',
              },
              {
                id: 'shell-vpower-racing',
                label: 'Shell V-Power Racing',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-vpower-racing',
              },
            ],
          },
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-fuelsave',
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg',
              },
              {
                id: 'lpg-installation-myths',
                label: 'Instalacja gazowa – prawdy i mity',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg/instalacja-gazowa-prawdy-i-mity',
              },
              {
                id: 'lpg-safe-refueling',
                label: 'Bezpieczne tankowanie LPG krok po kroku',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg/bezpieczne-tankowanie-lpg',
              },
              {
                id: 'lpg-formalities',
                label: 'Instalacja gotowa – czas na formalności',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg/formalnosci',
              },
              {
                id: 'lpg-where-install',
                label: 'LPG Auto – gdzie zamontować instalację gazową?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg/gdzie-zamontowac',
              },
              {
                id: 'lpg-car-care-tips',
                label: 'Jak dbać o swój samochód? Poznaj kilka wskazówek',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/shell-autogas-lpg/jak-dbac-o-samochod',
              },
            ],
          },
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/paliwa/benzyna-e10',
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne',
          },
          {
            id: 'shell-helix',
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix',
              },
              {
                ...
                children: [
                  {
                    ...
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ogolnego-zastosowania',
                  },
                  {
                    id: 'shell-helix-hx7-5w40',
                    label: 'Shell Helix HX7 5W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx7-5w40',
                  },
                  {
                    id: 'shell-helix-hx8-synthetic-5w40',
                    label: 'Shell Helix HX8 Synthetic 5W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx8-synthetic-5w40',
                  },
                  {
                    id: 'shell-helix-ultra-0w40',
                    label: 'Shell Helix Ultra 0W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-0w40',
                  },
                  {
                    id: 'shell-helix-ultra-diesel-5w40',
                    label: 'Shell Helix Ultra Diesel 5W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-diesel-5w40',
                  },
                  {
                    id: 'shell-helix-hx5-15w40',
                    label: 'Shell Helix HX5 15W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx5-15w40',
                  },
                  {
                    id: 'shell-helix-hx7-diesel-10w40',
                    label: 'Shell Helix HX7 Diesel 10W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx7-diesel-10w40',
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    ...
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ect',
                  },
                  {
                    id: 'shell-helix-hx8-ect-5w40',
                    label: 'Shell Helix HX8 ECT 5W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx8-ect-5w40',
                  },
                  {
                    id: 'shell-helix-hx8-5w30',
                    label: 'Olej silnikowy Shell Helix HX8 5W-30',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx8-5w30',
                  },
                  {
                    id: 'shell-helix-hx8-ect-c3',
                    label: 'Olej Shell Helix HX8 ECT C3',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/hx8-ect-c3',
                  },
                  {
                    id: 'shell-helix-ultra-0w30',
                    label: 'Olej silnikowy Shell Helix Ultra 0W-30',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-0w30',
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    ...
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/professional',
                  },
                  {
                    id: 'shell-helix-ultra-professional-0w30',
                    label: 'Olej silnikowy Shell Helix Ultra Professional 0W-30',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-professional-0w30',
                  },
                  {
                    id: 'shell-helix-ultra-professional-af-5w20',
                    label: 'Shell Helix Ultra Professional AF 5W-20',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-professional-af-5w20',
                  },
                  {
                    id: 'shell-helix-ultra-professional-apl-0w30',
                    label: 'Shell Helix Ultra Professional AP-L 0W-30',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-professional-apl-0w30',
                  },
                ],
              },
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-pureplus',
              },
              {
                id: 'shell-helix-ultra-0w',
                label: 'Shell Helix Ultra 0W',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-helix/ultra-0w',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance',
              },
              {
                id: 'shell-advance',
                label: 'Shell Advance',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance/shell-advance',
              },
              {
                id: 'shell-advance-2t',
                ...
                children: [
                  {
                    ...
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance/2t',
                  },
                  {
                    id: 'shell-advance-ultra-2',
                    label: 'Shell Advance Ultra 2',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance/ultra-2',
                  },
                ],
              },
              {
                ...
                children: [
                  {
                    ...
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance/4t',
                  },
                  {
                    id: 'shell-advance-4t-ax7-10w40',
                    label: 'Shell Advance 4T AX7 10W-40',
                    type: 'link',
                    to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-advance/4t-ax7-10w40',
                  },
                ],
              },
            ],
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-coolant',
              },
              {
                id: 'coolant-faq',
                label: 'Płyny do chłodnic - FAQ',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-coolant/faq',
              },
            ],
          },
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/shell-spirax',
          },
          {
            id: 'oil-distributor-locator',
            label: 'Lokalizator dystrybutorów olejów Shell',
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lokalizator-dystrybutorow',
          },
          {
            id: 'lubricants-faq',
            label: 'Środki smarne - FAQ',
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/faq',
          },
          {
            id: 'lubematch',
            label: 'Dobierz olej do silnika z Shell LubeMatch',
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lubematch',
          },
          {
            id: 'oils-blog',
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog',
              },
              {
                id: 'synthetic-vs-semisynthetic',
                label: 'Olej syntetyczny czy półsyntetyczny? Sprawdź różnice',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/olej-syntetyczny-vs-polsyntetyczny',
              },
              {
                id: 'power-loss-causes',
                label: 'Nagły spadek mocy silnika podczas jazdy - przyczyny',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/nagly-spadek-mocy-silnika',
              },
              {
                id: 'oil-viscosity-explained',
                label: 'Co oznacza lepkość oleju silnikowego? Sprawdź!',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/lepkość-oleju-wyjasnienie',
              },
              {
                id: 'ev-battery-lifetime-fluids',
                label: 'Żywotność baterii w samochodach elektrycznych a stosowane płyny',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/zywotnosc-baterii-a-plyny',
              },
              {
                id: 'gearbox-oil-choice',
                label: 'Jaki olej do skrzyni biegów? Podpowiadamy!',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/jaki-olej-do-skrzyni-biegow',
              },
              {
                id: 'hydraulic-oil-change',
                label: 'Przepracowany olej hydrauliczny – wymiana',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/wymiana-oleju-hydraulicznego',
              },
              {
                id: 'hybrid-oil-choice',
                label: 'Jaki olej do hybrydy?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/jaki-olej-do-hybrydy',
              },
              {
                id: 'motorcycle-oil-choice',
                label: 'Jaki olej do motocykla?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/jaki-olej-do-motocykla',
              },
              {
                id: 'tractor-oil-choice',
                label: 'Jaki olej do ciągnika wybrać? Doradzamy',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/jaki-olej-do-ciagnika',
              },
              {
                id: 'excavator-hydraulic-oil',
                label: 'Jaki olej hydrauliczny do koparki?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/jaki-olej-hydrauliczny-do-koparki',
              },
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/wysokie-spalanie-benzyny',
              },
              {
                id: 'acea-classification',
                label: 'Klasyfikacja ACEA',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/klasyfikacja-acea',
              },
              {
                id: 'engine-oil-leak',
                label: 'Wyciek oleju z silnika – przyczyny, objawy i konsekwencje',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/wyciek-oleju-z-silnika',
              },
              {
                id: 'dynamic-oil-change',
                label: 'Dynamiczna wymiana oleju – jak przebiega?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/dynamiczna-wymiana-oleju',
              },
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/uklad-smarowania-silnika',
              },
              {
                id: 'no-oil-consequences',
                label: 'Brak oleju w silniku – czym skutkuje dalsza jazda?',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/brak-oleju-w-silniku',
              },
              {
                id: 'oil-expiry-date',
                label: 'Czy olej silnikowy ma datę ważności? Zasady przechowywania otwartego oleju',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/blog/data-waznosci-oleju',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego',
              },
              {
                id: 'oil-viscosity-0w20',
                label: 'Oleje silnikowe 0W20',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/0w20',
              },
              {
                id: 'oil-viscosity-5w30',
                label: 'Oleje silnikowe 5W-30',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/5w30',
              },
              {
                id: 'oil-viscosity-10w60',
                label: 'Oleje silnikowe 10W60',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/10w60',
              },
              {
                id: 'oil-viscosity-5w40',
                label: 'Oleje silnikowe 5W40',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/5w40',
              },
              {
                id: 'oil-viscosity-10w40',
                label: 'Oleje silnikowe 10W40',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/10w40',
              },
              {
                id: 'oil-viscosity-0w30',
                label: 'Oleje silnikowe 0W-30',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/0w30',
              },
              {
                id: 'oil-viscosity-15w40',
                label: 'Oleje silnikowe 15W40',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/oleje-i-srodki-smarne/lepkość-oleju-silnikowego/15w40',
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/sporty-motorowe',
          },
          {
            id: 'motorsport-track-to-road',
            label: 'Z toru wyścigowego na drogę',
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/sporty-motorowe/z-toru-na-droge',
          },
          {
            id: 'motorsport-75-years-ferrari',
            label: '75 lat współpracy z Ferrari',
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/sporty-motorowe/75-lat-z-ferrari',
          },
        ],
      },
      {
        ...
        type: 'link',
        to: '/paliwa-oleje-i-plyny-do-chlodnic/porady-i-wskazowki',
      },
      {
        id: 'inspirations',
        ...
        children: [
          {
            ...
            type: 'link',
            to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy',
          },
          {
            id: 'secret-routes',
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy',
              },
              {
                id: 'secret-routes-amsterdam',
                label: 'Amsterdam',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/amsterdam',
              },
              {
                id: 'secret-routes-barcelona',
                label: 'Barcelona',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/barcelona',
              },
              {
                id: 'secret-routes-berlin',
                label: 'Berlin',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/berlin',
              },
              {
                id: 'secret-routes-london',
                label: 'Londyn',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/londyn',
              },
              {
                id: 'secret-routes-bruges',
                label: 'Brugia',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/brugia',
              },
              {
                id: 'secret-routes-madrid',
                label: 'Madryt',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/madryt',
              },
              {
                id: 'secret-routes-paris',
                label: 'Paryż',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/paryz',
              },
              {
                id: 'secret-routes-marrakesh',
                label: 'Marrakesz',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/marrakesz',
              },
              {
                id: 'secret-routes-prague',
                label: 'Praga',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/praga',
              },
              {
                id: 'secret-routes-rome',
                label: 'Rzym',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/rzym',
              },
              {
                id: 'secret-routes-san-francisco',
                label: 'San Francisco',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/san-francisco',
              },
              {
                id: 'secret-routes-tokyo',
                label: 'Tokio',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/tokio',
              },
              {
                id: 'secret-routes-warsaw',
                label: 'Warszawa',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/sekretne-trasy/warszawa',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem',
              },
              {
                id: 'biker',
                label: 'B jak biker',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/b-jak-biker',
              },
              {
                id: 'high-in-the-mountains',
                label: 'Wysoko w górach',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/wysoko-w-gorach',
              },
              {
                id: 'midnight-sun',
                label: 'Słońce o północy',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/slonce-o-polnocy',
              },
              {
                id: 'pacific-highway',
                label: 'Pacific Highway',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/pacific-highway',
              },
              {
                id: 'devils-race',
                label: 'Diabelski wyścig',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/diabelski-wyscig',
              },
              {
                id: 'road-to-norway',
                label: 'Droga do Norwegii',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/droga-do-norwegii',
              },
              {
                id: 'storm-warnings',
                label: 'Ostrzeżenia burzowe',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/poza-utartym-szlakiem/ostrzezenia-burzowe',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-samochodowe',
              },
              {
                id: 'european-trips',
                label: 'Najciekawsze wyprawy po Europie',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-samochodowe/europa',
              },
              {
                id: 'world-best-routes',
                label: 'Najlepsze trasy świata',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-samochodowe/swiat',
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-marzen',
              },
              {
                id: 'vicki-butler-henderson',
                label: 'Jazda z Vicki-Butler Henderson',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-marzen/vicki-butler-henderson',
              },
              {
                id: 'dream-routes-drivers-bikers',
                label: 'Trasy marzeń dla kierowców i motocyklistów',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-marzen/dla-kierowcow-i-motocyklistow',
              },
              {
                id: 'gary-inman-sandstorm',
                label: 'Gary Inman – Burza piaskowa',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-marzen/gary-inman-burza-piaskowa',
              },
              {
                id: 'enzo-built-city',
                label: 'Miasto zbudowane przez Enzo',
                type: 'link',
                to: '/paliwa-oleje-i-plyny-do-chlodnic/inspiracje-do-jazdy/trasy-marzen/miasto-zbudowane-przez-enzo',
              },
            ],
          },
        ],
